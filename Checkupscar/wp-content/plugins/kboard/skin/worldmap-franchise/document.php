<div id="kboard-worldmap-franchise-document">
	...
	<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
		...
		<div class="kboard-worldmap-franchise-info <?php if($content->getThumbnail(400, 400)):?>add-franchise-thumbnail<?php endif?>">
			<div class="kboard-worldmap-franchise-info-wrap">
				...
				<div class="kboard-franchise-thumbnail">
					<img src="<?php echo $content->getThumbnail(400, 400)?>" alt="">
				</div>
				<?php endif?>
				...
				<div class="kboard-franchise-attr-wrap">
					<div class="kboard-franchise-attr"><?php echo __('Branch', 'kboard-worldmap-franchise')?> :</div>
					<div class="kboard-franchise-value"><?php echo $content->option->branch?></div>
				</div>
				<?php endif?>
				...
				<div class="kboard-franchise-attr-wrap">
					<div class="kboard-franchise-attr"><?php echo __('Contact', 'kboard-worldmap-franchise')?> :</div>
					<div class="kboard-franchise-value"><a href="tel:<?php echo esc_attr($content->option->tel)?>"><?php echo $content->option->tel?></a></div>
				</div>
				<?php endif?>
				<?php if($content->option->homepage): $kboard_homepage = kboard_worldmap_franchise_homepage($content->option->homepage)?>
				<div class="kboard-franchise-attr-wrap">
					<div class="kboard-franchise-attr"><?php echo __('Homepage', 'kboard-worldmap-franchise')?> :</div>
					<div class="kboard-franchise-value"><a href="<?php echo esc_attr($kboard_homepage)?>" onclick="window.open(this.href); return false;"><?php echo $kboard_homepage?></a></div>
				</div>
				<?php endif?>
			</div>
		</div>
		...
		<div class="mobile-thumbnail">
			<img src="<?php echo $content->getThumbnail(600, 600)?>" alt="">
		</div>
		<?php endif?>
	...
	<div class="kboard-control">
		...
		<div class="right">
			...
			<a href="<?php echo $url->getContentEditor($content->uid)?>" class="kboard-worldmap-franchise-button-small"><?php echo __('Edit Place', 'kboard-worldmap-franchise')?></a>
			<a href="<?php echo $url->getContentRemove($content->uid)?>" class="kboard-worldmap-franchise-button-small" onclick="return confirm('<?php echo __('Are you sure you want to delete?', 'kboard')?>');"><?php echo __('Delete Place', 'kboard-worldmap-franchise')?></a>
			<?php endif?>
		</div>
	</div>
