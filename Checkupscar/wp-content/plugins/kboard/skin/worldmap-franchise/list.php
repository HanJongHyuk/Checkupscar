<div id="kboard-worldmap-franchise-list">
	...
	<ul class="kboard-list">
		...
		<li class="kboard-list-item<?php if($content->uid == kboard_uid()):?> kboard-list-selected<?php endif?>">
			...
			<div class="kboard-worldmap-franchise-wrap">
				<a href="<?php echo $url->getDocumentURLWithUID($content->uid)?>" title="<?php echo esc_attr($content->getUserName())?>">
	...
	<div class="kboard-control">
		<a href="<?php echo $url->getContentEditor()?>" class="kboard-worldmap-franchise-button-small"><?php echo __('Register Place', 'kboard-worldmap-franchise')?></a>
	</div>
	<!-- 버튼 끝 -->
	<?php endif?>
