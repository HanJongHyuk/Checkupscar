<div id="kboard-document">
	<div id="kboard-card-gallery-document">
		<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
			...
			<div class="kboard-detail">
				...
				<div class="detail-attr detail-writer">
					<div class="detail-name"><img src="<?php echo $skin_path?>/images/icon-user.png" alt="<?php echo __('Author', 'kboard')?>"></div>
					<div class="detail-value"><?php echo $content->getUserDisplay()?></div>
				</div>
				<div class="detail-attr detail-date">
					<div class="detail-name"><img src="<?php echo $skin_path?>/images/icon-date.png" alt="<?php echo __('Date', 'kboard')?>"></div>
					<div class="detail-value"><?php echo date('Y-m-d H:i', strtotime($content->date))?></div>
				</div>
				<div class="detail-attr detail-view">
					<div class="detail-name"><img src="<?php echo $skin_path?>/images/icon-view.png" alt="<?php echo __('Views', 'kboard')?>"></div>
					<div class="detail-value"><?php echo $content->view?></div>
				</div>
				<div class="detail-attr detail-view">
					<div class="detail-name"><img src="<?php echo $skin_path?>/images/icon-heart.png" alt="<?php echo __('Vote', 'kboard')?>"></div>
					<div class="detail-value"><?php echo intval($content->vote)?></div>
				</div>
			</div>
		...
		<div class="kboard-control">
			<div class="left">
				<a href="<?php echo $url->getBoardList()?>" class="kboard-card-gallery-button-small"><?php echo __('List', 'kboard')?></a>
			</div>
